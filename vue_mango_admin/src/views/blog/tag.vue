        ...
        <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="570px">
          <el-form ref="form" :inline="true" :model="form" size="small" label-width="66px">
            <el-form-item label="标签名" prop="content">
              <el-input v-model="form.content" @keydown.native="keydown($event)" style="width: 450px"/>
            </el-form-item>
      ...
      <!--管理员管理-->
        <el-card class="box-card" shadow="never">
          ...
          >
            ...
            <el-table-column :show-overflow-tooltip="true" prop="content" label="标签简介" width="300"/>
            <el-table-column label="点击数" width="200" prop="clickCount">
