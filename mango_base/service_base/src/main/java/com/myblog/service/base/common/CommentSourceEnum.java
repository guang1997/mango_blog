...
//    ABOUT_MESSAGE("ABOUT_MESSAGE", 0, "关于我页面评论"),
    ...
    private static List<String> blogCommentSourceList = new ArrayList<>();
    private static List<String> likeSourceList = new ArrayList<>();
    ...
    static {
        ...
        blogCommentSourceList.add(BLOG_INFO_MESSAGE.getSource());
        blogCommentSourceList.add(BLOG_INFO_COMMENT_LIKES.getSource());
        likeSourceList.add(BLOG_INFO_COMMENT_LIKES.getSource());
        likeSourceList.add(MESSAGE_BOARD_LIKES.getSource());
    ...
    public static List<String> getLikeSourceList() {
        return likeSourceList;
    }

    public static List<String> getBlogCommentSourceList() {
        return blogCommentSourceList;
    }
